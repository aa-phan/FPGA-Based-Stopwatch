...
HD_PWD='C:/Users/Aaron/Documents/ECE 316/Lab6_a/Lab6.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log watch_main.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source watch_main.tcl -notrace
