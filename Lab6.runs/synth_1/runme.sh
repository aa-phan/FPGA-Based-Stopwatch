...
HD_PWD='C:/Users/Aaron/Documents/ECE 316/Lab6_a/Lab6.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log watch_main.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source watch_main.tcl
